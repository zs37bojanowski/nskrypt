...
\title{\textsc{\huge{NSkrypt PSO/PSK}}}
...
Wszystkie polecenia z pozycji roota:
\begin{enumerate}
\item{\textbf{fdisk -l}}
...
\end{verbatim}
Powyższa komenda zamieni podkreślenia na spacje, ułoży w 3-ch kolumnach i zapisze do pliku.
...
\subsection{sortowania\footnote{\url{http://www.computerhope.com/unix/usort.htm}}}
...
CUPS (Common Unix Printing System) -- modularny system druku dla Unix-like systemów operacyjnych, który pozwala stacji stać się serverem wydruku. Na wszystkich systemach CUPS-em zarządza się poprzez przeglądarkę na porcie 631 (np. \textit{http://localhost:631})\footnote{\url{https://en.wikipedia.org/wiki/CUPS}}.
...
\end{verbatim}
\subsection{The difference between “s” and “S” in ls -la}
