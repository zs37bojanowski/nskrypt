...
Zamiast umieszczać ulubione przez windowsiaków zrzuty ekranów, umieszczam zawartość plików konfiguacyjnych dostępnych w SLES z shella jak w każdym linuxie.
\subsection{sshfs}
...
Usuń błędny wpis poleceniem: \textbf{sed -i 'jakaś liczba tutaj' ssh/known_hosts}.
\begin{enumerate}
