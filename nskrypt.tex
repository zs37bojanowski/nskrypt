...
^ -- daszek (Caret/Power symbol) stawia się przed znakiem, który ma znajdować się na na początku linii (nazwy,
) pliku, katalogu itp.

$ -– stawia się po znaku, który ma znajdować się na na końcuu linii (nazwy) pliku, katalogu itp.
