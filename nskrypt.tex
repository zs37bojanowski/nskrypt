...
\begin{listing}[1]{przykład}
w katalogu jest sześć katalogów: babac, bac, baca, fata , fatac i fatal. Znajdź te zaczynające się od \textit{b} lub \textit{f} i kończące się na \textit{c}.\newline
Rozwiązanie: \begin{verbatim}ls | grep '[bf]*c$'\end{verbatim}
\end{listing}
